...
exports.update = (req, res) => {
  ...
  let { fullbag, halfbag, quarterbag } = req.body;
  ...
  db.updateById(parseInt(req.params.customerId), fullbag, halfbag, quarterbag, (err, data) => {
    ...
    if (err) {
      ...
      req.flash("success", "Product amount changed successfully");
      return res.redirect("back");
    }
